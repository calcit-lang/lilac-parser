...
{} (:about "|Machine-generated snapshot. Do not edit directly — changes will be overwritten. Use `calcit query` to inspect and `calcit edit`/`calcit tree` to modify. Run `calcit docs agents --contract` before mutations; use `--full` for first orientation or changed contract digest. Manual edits must follow format and schema conventions, then run `calcit edit format`.") (:package |lilac-parser)
  :entries $ {}
                ...
                div
                  ...
                  div
                    ...
                    span $ {} (:inner-text |GUI) (:class-name css-gui-toggler)
                      :style $ {}
                        :color $ if (&map:get state :gui?) (hsl 200 80 40) (hsl 200 80 80)
                      :on-click $ fn (e d!)
                        d! cursor $ &map:assoc state :gui?
                          not $ &map:get state :gui?
                    =< 16 nil
                    ...
                    if has-children?
                      comp-icon
                        ...
                        {} (:font-size 14)
                          ...
                          :cursor :pointer
                        fn (e d!)
                          d! cursor $ &map:assoc state :folded?
                            not $ &map:get state :folded?
                      comp-icon :minus
                        {} (:font-size 14)
                          :color $ hsl 200 80 90
                          :margin 8
